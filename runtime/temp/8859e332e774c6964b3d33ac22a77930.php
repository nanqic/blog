...
<body>
    ...
    <div class="nav">
                <div style="display: inline-block; "><img src="/static/index/images/bitbull.png"  style="height: 50px" alt=""></div>
                <div class="right">
            <div class="box">
		...
		<div class="left">
			...
			<div class="xnews2">
				...
				<div style="display: inline-block; margin-right: 20px">
					<img src="blog.me//<?php echo $vo['pic']; ?>" height="150" width="220" alt="">
				</div>
				<?php else: ?>
