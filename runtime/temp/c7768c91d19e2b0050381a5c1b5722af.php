<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\Software\Wamp\www\blog\public/../application/admin\view\article\lst.html";i:1561551131;s:67:"D:\Software\Wamp\www\blog\application\admin\view\common\header.html";i:1561555873;s:68:"D:\Software\Wamp\www\blog\application\admin\view\common\sidebar.html";i:1561357599;}*/ ?>
<!DOCTYPE html>
<html>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <?php if($vo['pic'] != ''): ?>
                                                        <div>
                                                            <img src="http://127.0.0.1/blog/public/<?php echo $vo['pic']; ?>" height="30" width="50" alt="">
                                                        </div>
                                                        <?php else: ?>
                                                        暂无缩略图
                                                        <?php endif; ?>
                                                    ...
                                                    <td align="center" width="18%">
                                                        <a href="<?php echo url('article/edit',array('id'=>$vo['id'])); ?>"
                                                            class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a href="#"
                                                            onClick="warning('确实要删除吗', '<?php echo url('article/del',array('id'=>$vo['id'])); ?>')"
