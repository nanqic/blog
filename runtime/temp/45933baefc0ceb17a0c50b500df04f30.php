<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\Software\Wamp\www\blog\public/../application/admin\view\article\add.html";i:1561551107;s:67:"D:\Software\Wamp\www\blog\application\admin\view\common\header.html";i:1561555873;s:68:"D:\Software\Wamp\www\blog\application\admin\view\common\sidebar.html";i:1561357599;}*/ ?>
<!DOCTYPE html>
<html>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" role="form" action="" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control" id="pic" placeholder="" name="pic"
                                                        type="file">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <label>
                                                        <input class="checkbox-slider" type="checkbox" name="state">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea id="editor" name="content" placeholder="写点什么.."
                                                        autofocus></textarea>
